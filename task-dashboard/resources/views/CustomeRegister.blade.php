...
<nav class="navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none my-3  navbar-transparent mt-4">
    <div class="container">
        <a href="/" class="navbar-brand font-weight-bolder ms-lg-0 ms-3 text-white" href="">
            Analytics Lab
        </a>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-5 text-center mx-auto">
                    ...
                    <p class="text-lead text-white">Use these awesome forms to login or create new Admin in your dashboard.</p>
                </div>
            </div>
        </div>
    </div>

...
<div class="Patients py-5">
    <div class="container-lg container-fluid">
        ...
        <form id="contact" action="{{route('news.store')}}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            @endif
            <fieldset>
                <input placeholder="Your headline" type="text" name="newsHeadline" tabindex="1" required autofocus>
            </fieldset>
            <fieldset>
                <input placeholder="Your text content"  name="content" type="text" tabindex="2" required>
            </fieldset>
